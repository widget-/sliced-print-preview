...
const ambientStrength = ref(1.0);
const baseColorTint = ref('#ffffff');
const ssaoEnabled = ref(true);
const roleColors = ref(true);
const shadowSoftness = ref(4.0);
const keyLightIntensity = ref(1.5);
const fillLightIntensity = ref(1.0);
const contactShadowDist = ref(0.0);
const contactShadowStrength = ref(0.0);
const ssaoIntensity = ref(0.4);
const ssaoRadius = ref(0.6);
